...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--optim_w_norm_lambda', default=1., type=float, help='weight of wnorm loss')
		...
		self.parser.add_argument('--edit_layer', type=str, default='', help='edit layer')
		...
		self.parser.add_argument('--test_info_path', type=str, default='', help='condition path')
		self.parser.add_argument('--test_inversion_path', type=str, default='', help='inversion path')
		self.parser.add_argument('--optim_kp_lambda', default=0., type=float, help='weight of kp loss')
		self.parser.add_argument('--optim_seg_lambda', default=0., type=float, help='weight of seg loss')
		self.parser.add_argument('--optim_id_lambda', default=0., type=float, help='weight of id loss')
		self.parser.add_argument('--save_folder', default="test", type=str, help='folder to save')

...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--kp_lambda', type=float, default=0., help="lambda for kp loss")
        ...
        # new
        self.parser.add_argument('--new_optimizer', default='ranger', type=str, help='Which new optimizer to use.')
        self.parser.add_argument('--new_lr', default=0.0001, type=float, help='New optimizer learning rate.')

        # edit
        self.parser.add_argument('--g_layers', default=3, type=int, help='edit stylegan layers.')
